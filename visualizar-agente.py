...
def jugar_con_agente(config_file, genoma_file, mapa=None):
    ...
    if mapa is None:
        ...
        enemigo = f"LiuKangVsLiuKang_VeryHard_06"
    else :
...
if __name__ == "__main__":
    ...
    jugar_con_agente("config-neat", "generaciones/mejor_agente.pkl", "very_hard")

    # for i in range(2, 16):
    #     jugar_con_agente("config-neat", "generaciones/mejor_agente.pkl", i)
